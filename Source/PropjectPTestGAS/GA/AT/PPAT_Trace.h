 ...
 */
UCLASS()
class PROPJECTPTESTGAS_API UPPAT_Trace : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UPPAT_Trace* CreateTask(UGameplayAbility* OwningAbility, TSubclassOf<class APPTA_Trace> TargetActorClass);
