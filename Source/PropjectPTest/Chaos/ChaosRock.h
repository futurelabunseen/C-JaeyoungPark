...
protected:
    ...
    UPROPERTY(EditInstanceOnly, Category = "Destruction")
    class ALevelSequenceActor* LinkedSequenceActor;

    // 사운드 컴포넌트
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DestructionAudio")
